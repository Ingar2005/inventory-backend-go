...
const (
	createSuppliers = (`
	    ...
	    lead_time int,
	    monday_deliver boolean,
	    tuesday_deliver boolean,
	    wednesday_deliver boolean,
	    thursday_deliver boolean,
	    friday_deliver boolean,
	    saturday_deliver boolean,
	    sunday_deliver boolean,
	    PRIMARY KEY (supplierID));`)
	genericSupplier = `
		INSERT IGNORE INTO suppliers
		(supplierID, supplier_name, lead_time,
	 	monday_deliver, tuesday_deliver, wednesday_deliver, thursday_deliver, friday_deliver, saturday_deliver, sunday_deliver)
